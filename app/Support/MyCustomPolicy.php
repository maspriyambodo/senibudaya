...
//        parent::configure();
        $this
                ...
                ->addDirective(Directive::IMG, 'self data: blob: https://10.11.11.133 *.froala.com *.google.com kemenag.go.id *.cloudflare.com cdn-cookieyes.com scentivaid.com img.youtube.com dev.alfabet.io kemenag.go.id android-webview-video-poster: data:')
