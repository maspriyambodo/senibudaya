...
class ContentController extends Controller {
    ...
    public function index() {
        ...
        $tokoh = Tokoh::where('status_tokoh', 't')->orderBy('created_at', 'desc')->paginate(2);
    ...
    public function show(Request $request) {
        ...
        if (strtolower($kategori) == 'link') {
            $link = Links::where('status_link', 't')->where('id_content', $content['id'])->orderBy('created_at')->paginate(9);
        }
        ...
        if (strtolower($kategori) == 'video') {
            $video = Video::where('status_video', 't')->where('id_content', $content['id'])->orderBy('created_at', 'desc')->paginate(6);
