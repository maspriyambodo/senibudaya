...
class Seniman extends AuthController {

    private $target = 'seniman.index_seniman';
    ...
    public function index() {
        ...
        $column = array(
            ...
            'data' => array('button', 'nama', 'provinsi', 'kabupaten', 'alamat', 'bidang', 'karya', 'lembaga', 'created_at'),
            'nosort' => array(0),
        );
    ...
    public function json(Request $request) {
        $exec = DtaSeniman::with('provinsi', 'kabupaten')->where('stat', 1);
