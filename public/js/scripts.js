...
function initGmag() {
	...
	*/
    ...
    function n() {
        if ($(".gallery-items").length) {
            var $grid = $(".gallery-items").isotope({
                ...
                itemSelector: ".videos-item, .gallery-link, .gallery-item, .gallery-item-second, .gallery-item-three"
            });
	...
	if ($(".banner-slider").length > 0) {
        var j2 = new Swiper(".banner-slider .swiper-container", {
            preloadImages: false,
            slidesPerView: 1,
            spaceBetween: 0,
            loop: true,
            ...
            mousewheel: false,
            pagination: {
                el: '.bs-slider-pagination',
                clickable: true,
            },
            navigation: {
                nextEl: '.bs-slider-cont-next',
                prevEl: '.bs-slider-cont-prev',
            },
        });
    }
	if ($(".info_carousel").length > 0) {
        var j2 = new Swiper(".info_carousel .swiper-container", {
            preloadImages: false,
            freeMode: false,
            slidesPerView: 8,
            spaceBetween: 5,
