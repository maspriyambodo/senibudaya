        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <h1>XML Sitemap</h1>
                    <p class="expl">
                        Generated by <a href="bimasislam.kemenag.go.id" target="_blank" rel="noopener">BIMAS ISLAM</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
