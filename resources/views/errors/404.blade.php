...
<html lang="en">
    <head>
        ...
        <meta name="title" content="About Us — Repositori Seni Budaya" />
        <meta name="description" content="Prof. Dr. Phil. H. Kamaruddin Amin, MADirektur Jenderal Bimbingan Masyarakat Islam&amp;nbsp;Repositori Digital Seni Budaya Islam di Indonesia ini adalah inisiatif y" />
        ...
        <style>
            .page_speed_1563119258 {
                height: 15%;
                max-width: 75%;
            }
            .page_speed_140896480 {
                text-transform: uppercase;
            }
            .page_speed_1576582063 {
                font-family: Poppins;
            }
            .page_speed_949168153 {
                font-size: 15px;
                font-family: Poppins;
            }
            .page_speed_1328018746 {
                font-size: 16px;
                font-family: Poppins;
            }
            .page_speed_478325005 {
    ...
    <body>
        <nav class="navbar navbar-expand-lg classic transparent navbar-light navbar-clone fixed navbar-unstick">
            <div class="container flex-lg-row flex-nowrap align-items-center">
                <div class="navbar-brand w-100">
                    <a href="{{ route('landing.home') }}">
                    <img src="{{ asset('images/repositori_logo.png'); }}" alt="logo repositori" class="logo lazy" height="65" style="height: 15%;max-width: 75%;">
                </a>
                </div>
        ...
        <div class="content-wrapper">
            <header class="wrapper bg-light">
                <nav class="navbar navbar-expand-lg classic transparent navbar-light">
                    <div class="container flex-lg-row flex-nowrap align-items-center">
                        <div class="navbar-brand w-100">
                            <a href="{{ route('landing.home') }}">
                    <img src="{{ asset('images/repositori_logo.png'); }}" alt="repositori logo" class="logo lazy" height="65" style="height: 15%;max-width: 75%;">
                </a>
                        </div>
                        <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                            <div class="offcanvas-header d-lg-none">
            ...
            <div class="offcanvas offcanvas-top bg-light" id="offcanvas-search" data-bs-scroll="true">
                <div class="container d-flex flex-row py-6">
                    <form class="search-form w-100"><input id="search-form" type="text" class="form-control" placeholder="Type keyword and hit enter" /></form>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-xl-8 mx-auto">
                            <div class="post-header">
                                <div class="post-category text-line"></div>
                                <h1 class="display-1 mb-4">Halaman tidak ditemukan</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="text-inverse page_speed_478325005">
            <div class="container pt-12 pt-lg-6 pb-13 pb-md-15">
                <div class="row gy-6 gy-lg-0 mt-11 mb-12">
                    <div class="col-md-4 col-lg-4">
                        <div class="widget">
                            <img width="170" class="mb-4" src="index_files/logo.png" alt="Logo" srcset="index_files/logo.png 2x" />
                            <p class="mb-4">© 2024 Repositori Seni Budaya. All Rights Reserved.</p>
        ...
        <script src="index_files/jquery-3.6.4.min.js"></script>
        <script src="index_files/toastr.min.js"></script>
        <script src="index_files/sweetalert2.all.min.js"></script>
        <script>
