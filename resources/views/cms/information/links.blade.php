				...
				<div class="modal-body">
					<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input id="nama_link" name="nama_link" type="text" class="form-control" {{ noEmpty('Judul tidak boleh kosong.') }}>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Keterangan</label>
							<div class="col-sm-9">
								<textarea id="keterangan_link" name="keterangan_link" rows="1" class="form-control"></textarea>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">URL</label>
							<div class="col-sm-9">
								<input id="url_link" name="url_link" type="text" class="form-control" {{ noEmpty('URL tidak boleh kosong.') }}>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="custom-file">
									<input id="image_link" name="image_link" type="file" accept="image/*" class="custom-file-input" {{ noEmpty('Logo tidak boleh kosong.') }}>
									<label class="custom-file-label" for="image_link">Pilih Gambar</label>
								</div>
								<img id="img_link" class="user-img-radious-style mt-1 w-25 d-none">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Status</label>
							<div class="col-sm-9 switch switch-success">
								<input type="checkbox" id="status_link" name="status_link" />
								<label for="status_link" class="cr"></label>
								<label for="status_link">Aktif ?</label>
							</div>
						</div>
				</div>
