				...
				<div class="modal-body">
					<div class="form-group row">
							...
							<div class="col-sm-9">
								...
								<input id="nama_foto" name="nama_foto" type="text" class="form-control" {{ noEmpty('Judul tidak boleh kosong.') }}>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Keterangan</label>
							<div class="col-sm-9">
								<textarea id="keterangan_foto" name="keterangan_foto" rows="1" class="form-control"></textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="custom-file">
									<input id="image_foto" name="image_foto" type="file" accept="image/*" class="custom-file-input" {{ noEmpty('Image tidak boleh kosong.') }}>
									<label class="custom-file-label" for="image_foto">Pilih Gambar</label>
								</div>
								<img id="img_foto" class="user-img-radious-style mt-1 w-25 d-none">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Status</label>
							<div class="col-sm-9 switch switch-success">
								<input type="checkbox" id="status_foto" name="status_foto" />
								<label for="status_foto" class="cr"></label>
								<label for="status_foto">Aktif ?</label>
							</div>
						</div>
				</div>
