						...
						<table width="100%" class="table table-striped table-responsive-xl" id="data">
							<thead>
								<tr>
									...
									<th style="min-width:200px">Alamat Email</th>
			...
			<form action="{{ $current }}/store" method="post" class="needs-validation" novalidate="">
				...
				<div class="modal-body">
					<div class="form-group row">
						...
						<div id="nama_kontak" class="col-sm-8"></div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">Alamat Email</label>
						<div class="col-sm-1">:</div>
						<div id="email_kontak" class="col-sm-8"></div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">Pesan</label>
						<div class="col-sm-1">:</div>
						<div id="detail_kontak" class="col-sm-8"></div>
					</div>
					<div class="form-group row">
