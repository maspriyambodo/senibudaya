            ...
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE;">
                    <img src="https://mailsend-email-assets.mailtrap.io/pl6yylgbqo1go4uoejrs9ha2e7fe.png"/>
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          we accept account registration on our system: <span style="color: #4C83EE;">{{ $user_email }}</span>.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <a class="button" href="{{ $pass_reset_link }}" title="User Activation" style="width: 100%; background: #22D172; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">activate</a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          The activation link is only valid for the next 10 minutes.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 60px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          If you did not request the account registration, please ignore this message or contact our support at <a href="mailto:bimasislam@kemenag.go.id">bimasislam@kemenag.go.id</a>.
                        </td>
                      </tr>
                      <tr>
